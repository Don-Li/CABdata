#### variable_interval_1_2017 dataset
...
#'
#' @seealso \link{variable_interval_1_2017_tibble} for the same dataset but with \code{tibble}s (i.e. data frames) instead of \code{formal_event_record}s or \code{data.table}s.
#'
#' @name variable_interval_1_2017
#' @docType data
#' @usage data(variable_interval_1_2017)
